...
[![tests](https://img.shields.io/badge/tests-625%20passing-success?style=flat-square)](#develop)
...
```bash
npm install
npm test                                   # 625 tests - gate, audit, executor, stores, rails, harness, surfaces
